...
//Slider template
if ( ! function_exists( 'bst_slider_template' ) ) :
    function bst_slider_template() {
        ...
        if ( (get_theme_mod('front_header_type','slider') == 'slider' && is_front_page()) || (get_theme_mod('site_header_type') == 'slider' && !is_front_page()) ) {
            ...
            if ( !function_exists('pll_register_string') ) {
                $slider_title_1     = get_theme_mod('slider_title_1', 'Welcome to bst');
                ...
                $slider_title_1     = pll__(get_theme_mod('slider_title_1', 'Welcome to bst'));
            ...
            <div id="slideshow" class="header-slider" data-speed="<?php echo esc_attr($speed); ?>">
                <div class="slides-container">
                    <?php
                    if ( get_theme_mod('slider_image_1', get_template_directory_uri() . '/images/slide1600x792.png') ) {
                        echo '<div class="slide-item" style="background-image:url(' . esc_url(get_theme_mod('slider_image_1', get_template_directory_uri() . '/images/slide1600x792.png')) . ');">';
                        ?>
